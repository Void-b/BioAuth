...
public class RetrievePrintOnly extends AppCompatActivity {
    ImageView ivFinger;
    TextView tvMessage;
    byte[] img;
    Bitmap bm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieve_print_only);
        tvMessage = (TextView) findViewById(R.id.tvMessage1);
        ivFinger = (ImageView) findViewById(R.id.ivFingerDisplay1);
        okay = (Button) findViewById(R.id.okay1);
        okay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(RetrievePrintOnly.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(RetrievePrintOnly.this,
...
//        int status = msg.getData().getInt("status");
    ...
    private void saveBitmapAsPNG() {
        ...
        File directory = new File(Environment.getExternalStorageDirectory(), "/CBIMS/temp");
        if (!directory.exists()) {
            directory.mkdirs();
        }
        ...
        try {
            ...
            Toast.makeText(this, "Print Retrieved...", Toast.LENGTH_SHORT).show();
            finish();
//            handleIntent();
//            createAndSaveTextFile();
    ...
    public void startScan(View view) {
        Intent intent = new Intent(RetrievePrintOnly.this, IdentifyScan.class);
